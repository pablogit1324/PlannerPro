...
import PremiumInfo from "./function_premium";
            ...
            <div className={"pre container"}>
                ...
                <div className={"premium_box"}>
                    <div className={"premium_box_text"}>
                        <h3 className={"premium_heading_text"}><p><span className={"heading_orange"}>Premium</span> version</p> of the <span className={"heading_orange"}>application</span></h3>
                    </div>
                    <div className={"premium_text"}>

                        <div className={"premium_info"}>
                            <PremiumInfo image={bell} heading={"Pre-event notifications"}
                                          text={"Stay Ahead with Pre-Event Reminders and Updates."}/>
                            <PremiumInfo image={element} heading={"Company planning"}
